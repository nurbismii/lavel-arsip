...
class ActivityLog extends Model
{
    ...
    public function getActionLabelAttribute(): string
    {
        $labels = [
            ...
            'sop_pengetahuan.create' => 'Tambah SOP/Pengetahuan',
            'sop_pengetahuan.update' => 'Ubah SOP/Pengetahuan',
            'sop_pengetahuan.delete' => 'Hapus SOP/Pengetahuan',
            'sop_pengetahuan.lampiran.delete' => 'Hapus Lampiran SOP/Pengetahuan',
