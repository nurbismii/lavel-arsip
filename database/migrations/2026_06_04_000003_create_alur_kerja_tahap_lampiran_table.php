...
return new class extends Migration
{
    public function up()
    {
        if (Schema::hasTable('alur_kerja_tahap_lampiran')) {
            return;
        }

        Schema::create('alur_kerja_tahap_lampiran', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('alur_kerja_tahap_lampiran');
    }
};
