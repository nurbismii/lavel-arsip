...
<span class="brand-logo {{ $alignClass }}" aria-label="V-Ops">
    <span class="brand-logo-mark brand-logo-mark--{{ $sizeClass }}" aria-hidden="true">
        <svg class="brand-logo-svg" viewBox="0 0 72 72" focusable="false">
            ...
            <path d="M17 32 L30 49 L55 18" fill="none" stroke="#ffffff" stroke-width="8" stroke-linecap="round" stroke-linejoin="round" class="brand-logo-v" />
            <path d="M17 32 L30 49 L55 18" fill="none" stroke="#f59e0b" stroke-width="4.2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    </span>
