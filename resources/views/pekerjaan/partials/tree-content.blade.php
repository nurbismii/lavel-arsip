...
@php($completionNoteStatuses = [
\App\Models\Dokumen::STATUS_ARSIP,
\App\Models\Dokumen::STATUS_TIDAK_SELESAI,
\App\Models\Dokumen::STATUS_TIDAK_DIHADIRI,
])
...
<ul class="list-unstyled tree-list tree-branch tree-documents">
    ...
    <li class="tree-item">
        <div class="tree-document small">
            ...
            @if(in_array($doc->status_dokumen, $completionNoteStatuses, true))
            <div class="mt-2 ms-4">
                ...
                @endif
                @if($doc->status_dokumen === \App\Models\Dokumen::STATUS_ARSIP && $doc->buktiPenyelesaians->count())
                <div class="mt-1">
                ...
                @elseif($doc->status_dokumen === \App\Models\Dokumen::STATUS_ARSIP && $doc->bukti_penyelesaian_path)
                <small class="d-block">
            ...
            <form
                ...
                <div class="row g-2 align-items-end">
                    ...
                    <div
                        class="col-md-8 completion-fields {{ in_array($doc->status_dokumen, $completionNoteStatuses, true) ? '' : 'd-none' }}"
                        data-has-proof="{{ $doc->buktiPenyelesaians->count() || $doc->bukti_penyelesaian_path ? 'true' : 'false' }}">
                        <div class="completion-proof-fields {{ $doc->status_dokumen === \App\Models\Dokumen::STATUS_ARSIP ? '' : 'd-none' }}">
                            ...
                            <input
                                ...
                                multiple
                                {{ !$doc->buktiPenyelesaians->count() && !$doc->bukti_penyelesaian_path ? 'required' : '' }}>
                            <small class="text-muted d-block mt-1">
